...
public class URDragonModel<T extends URDragonEntity> extends GeoModel<T> {
    ...
    public Identifier getAnimationResource(T entity) {
        ...
        if (data != null && data.modelData().animation().isPresent()) {
            ...
            if (ResourceUtil.doesExist(id)) {
                ...
                return id;
            } else UselessReptile.LOGGER.warn("Failed to get animation for {} ({}) of variant {}. Default will be used instead", entity.getName(), entity.getDragonID(), entity.getVariant());
        }
    ...
    public Identifier getModelResource(T entity) {
        ...
        if (data != null && data.modelData().model().isPresent()) {
            ...
            if (ResourceUtil.doesExist(id)) {
                ...
                return id;
            } else UselessReptile.LOGGER.warn("Failed to get model for {} ({}) of variant {}. Default will be used instead", entity.getName(), entity.getDragonID(), entity.getVariant());
        }
    ...
    public Identifier getTextureResource(T entity) {
        ...
        if (data != null && ResourceUtil.doesExist(data.modelData().texture())) {
            ...
            return id;
        } else UselessReptile.LOGGER.warn("Failed to get texture for {} ({}) of variant {}. Default will be used instead", entity.getName(), entity.getDragonID(), entity.getVariant());
